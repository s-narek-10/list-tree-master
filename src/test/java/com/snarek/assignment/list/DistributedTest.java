...
public class DistributedTest {
    ...
    public void testCase5(){
        List<Integer> result = ListUtils.removeDuplicates(TestUtils.asList(1, 2, 1, 2, 1),
                APPEARANCE, IS_DELETE_IN_ROW);

        assertThat(result, CoreMatchers.is(TestUtils.asList(2, 2)));
    }
    ...
    public void testCase7(){
        ...
        assertThat(result, CoreMatchers.is(TestUtils.asList(3, 2)));
    }
    ...
    public void testCase14(){
        List<Integer> result = ListUtils.removeDuplicates(TestUtils.asList(1, null, 2, null, null, 1),
                APPEARANCE, IS_DELETE_IN_ROW);

        assertThat(result, CoreMatchers.is(TestUtils.asList(1, 2, 1)));
    }
